...
export function readMailData() {
  return readJsonFile(__dirname + "/data/mailData.json");
}
...
export function writeMailData(mailArray) {
  return writeJsonFile(__dirname + "/data/mailData.json", mailArray);
}
